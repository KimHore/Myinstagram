...
//  Copyright kimhore All rights reserved.
//
...
-(Kumulos*)init {
    ...
    if ([super init]) {
        theAPIKey = @"zyn3xbfyby3qr52s44d5y235jnh15qpy";
        theSecretKey = @"wrh2wzd4";
        useSSL = NO;
    }
...
-(KSAPIOperation*) createUserWithUsername:(NSString*)username andPasswd:(NSString*)passwd andEmail:(NSString*)email{
